/* Below program takes input from FILE and outputs to FILE. It performs operations Inorder Traversal, find all leaves, find generation of
 * given node, children, grand-children and sibling. */ 
